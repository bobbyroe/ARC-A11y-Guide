const allCriteria = [
  ...
  },
  {
    ...
    markdown: ' - Form buttons have a descriptive value',
    notes: 'TBD',
    'addl. info': ''
  },
  {
    ...
    DRRSFA: 'Description',
    '*thing*': 'Input',
    '[more info]()': 'https://webaim.org/standards/wcag/checklist',
    markdown: ' - Form inputs have good labels',
    notes: 'TBD',
  ...
  },
  {
    ...
    '*thing*': '*',
    '[more info]()': 'https://webaim.org/standards/wcag/checklist',
    markdown: ' - Ipsum lorem dolar molar growler grunt',
    notes:
